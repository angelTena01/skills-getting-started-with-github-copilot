...
activities = {
    ...
    "Soccer Team": {
        "description": "Competitive school soccer team practicing drills and matches",
    ...
    "Drama Club": {
        ...
        "max_participants": 25,
        "participants": ["sophia.r@mergington.edu", "lucas@mergington.edu"]
    },
    "Debate Team": {
...
# Add this endpoint after all other endpoints
